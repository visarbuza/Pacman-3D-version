...
execute_process(
  COMMAND "/usr/bin/git" show-ref b0796109629931b6fa6e449c15a177845256a407
  WORKING_DIRECTORY "/home/visar/Documents/NTNU/Courses/Graphics Programming/Exercise/Camera/build/_deps/glfw_external-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/b0796109629931b6fa6e449c15a177845256a407")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "b0796109629931b6fa6e449c15a177845256a407")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "b0796109629931b6fa6e449c15a177845256a407")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 b0796109629931b6fa6e449c15a177845256a407
  WORKING_DIRECTORY "/home/visar/Documents/NTNU/Courses/Graphics Programming/Exercise/Camera/build/_deps/glfw_external-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/visar/Documents/NTNU/Courses/Graphics Programming/Exercise/Camera/build/_deps/glfw_external-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/visar/Documents/NTNU/Courses/Graphics Programming/Exercise/Camera/build/_deps/glfw_external-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/bin/git" checkout b0796109629931b6fa6e449c15a177845256a407
      WORKING_DIRECTORY "/home/visar/Documents/NTNU/Courses/Graphics Programming/Exercise/Camera/build/_deps/glfw_external-src"
      RESULT_VARIABLE error_code
      )
    if(error_code)
